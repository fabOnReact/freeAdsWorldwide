class Run < ApplicationRecord
	...
	validates :runprintnumber, numericality: { greater_than: :ownads}

	def runprintnumber_smaller_then_ownads
		if runprintnumber < ownads
			errors.add(:ownads, 'The total number of copies must be equal or smaller to the number of your own fliers')
		end
	end
